...
import { addSingleItemToCart, removeSingleItemFromCart } from "../actions/actions";
...
export const ItemCard = ({ product, quantity }: Props) => {
  ...
  function onAddToCart() {
    addSingleItemToCart(product.id);
    router.refresh();
  }
  ...
  return (
    <div className="flex items-center p-2 shadow rounded-lg w-full dark:bg-gray-800 border-gray-100">
      ...
      <div className="flex p-5 mr-2 items-center justify-center gap-3">
        <button
          onClick={onAddToCart}
